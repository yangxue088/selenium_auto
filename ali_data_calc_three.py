...
with open('output/ali_three_result.csv', 'w') as ofile:
    ...
    with open('input/ali_industry.csv') as file:
        ...
        for one_text, two_text, three_text, four_text in csv.reader(file):
            ...
            if (one_text, two_text, three_text) in s:
                continue

            s.add((one_text, two_text, three_text))
            ...
            try:
                ...
                writer.writerow((one_text, two_text, three_text, '-') + three_cate_data)
